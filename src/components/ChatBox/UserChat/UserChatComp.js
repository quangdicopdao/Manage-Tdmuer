...
function UserChatComp({ imageUrl, name, lastMessage, isActive, onUserClick }) {
    return (
        <div className={cx('wrap-user-comp', { 'wrap-user-comp-active': isActive })} onClick={onUserClick}>
